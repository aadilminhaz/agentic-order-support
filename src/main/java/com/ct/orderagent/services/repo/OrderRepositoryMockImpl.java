...
public class OrderRepositoryMockImpl implements OrderRepository {
    ...
    public OrderRepositoryMockImpl() {
        ...
        orders.put("CT_101", order1);

        Order order2 = new Order();
        order2.setOrderId("CT_102");
        ...
        orders.put("CT_102", order2);

        Order order3 = new Order();
        order3.setOrderId("CT_103");
        ...
        orders.put("CT_103", order3);

        Order order4 = new Order();
        order4.setOrderId("CT_105");
        ...
        orders.put("CT_105", order4);

        Order order5 = new Order();
        order5.setOrderId("CT_107");
        ...
        orders.put("CT_107", order5);

        Order order6 = new Order();
        order6.setOrderId("CT_109");
